...
def objective(trial, args, dataloaders, class_info, device, logger):
    ...
    # After creating dataloaders with optimized transforms
    if hasattr(args, "optimize_augmentation") and args.optimize_augmentation:
        try:
            # ... existing code to create optimized dataloaders ...

            # [NEW CODE] Check dataset quality after optimization
            from src.utils.dataset_utils import dataset_quality_check
