def create_model(
    model_type, num_classes, use_weights=True, freeze_backbone=True, **kwargs
):
    """
    ...
    if model_type == "efficientnet":
        ...
        return create_efficientnet_model(num_classes, use_weights, freeze_backbone)

    elif model_type == "efficientnet_b3":
        from src.models.efficientnet import create_efficientnet_b3_model

        return create_efficientnet_b3_model(num_classes, use_weights, freeze_backbone)

    elif model_type == "mobilenet":
        from src.models.mobilenet import create_mobilenet_model

        return create_mobilenet_model(num_classes, use_weights, freeze_backbone)
        ...
        return create_mobilenet_v3_model(
            num_classes, use_weights, freeze_backbone, "small"
        )
        ...
        return create_mobilenet_v3_model(
            num_classes, use_weights, freeze_backbone, "large"
        )
        ...
        return create_mobilenet_model_with_attention(
            num_classes, use_weights, freeze_backbone
        )

    elif model_type == "resnet18":
        from src.models.resnet import create_resnet18_model

        return create_resnet18_model(num_classes, use_weights, freeze_backbone)

    elif model_type == "resnet50":
        from src.models.resnet import create_resnet50_model

        return create_resnet50_model(num_classes, use_weights, freeze_backbone)
        ...
        return create_resnet_with_attention(
            num_classes, resnet_version, use_weights, freeze_backbone
        )
